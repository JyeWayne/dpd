...
begin
  ...
  if not Query1.Eof then
    ...
    begin
      ...
      DateTimePicker3.DateTime :=  RocToTime(NullStrTo(FieldbyName('BookDate1').AsString,RocDate(now,'')));
...
begin
  ...
  begin
    ...
    begin
      ...
      Close;
      SQL.Clear;
      SQL.Add('Select hospice_basic.*,(select USER_name from User_basic where USER_id=oper_id) as a from hospice_basic where CHR_NO='+Qt(chr_no)+' and can_cd<>''Y'' order by 1');
      Open;
